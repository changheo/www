      ...
      <span class="all">* 모든 항목은 필수 입력 사항입니다.</span>
     	<tr>
     		...
     		<td>
     			 ...
     			 <input placeholder="아이디(8자이내 입력)" type="text" name="id" id="id" required>
     	...
     	<tr>
     		...
     		<td>
     			<input placeholder="이름" type="text" name="name" id="name"  required> 
     		</td>
     	</tr>
     	<tr>
     		<th class="hidden" scope="col"><label for="nick">닉네임</label></th>
     		<td>
     			 <input placeholder="닉네임" type="text" name="nick" id="nick"  required>
     	...
     	<tr>
     		...
     		<td>
     		  <label class="hidden" for="email1">이메일아이디</label>
     			<input placeholder="이메일" type="text" id="email1" name="email1"  required> @ 
