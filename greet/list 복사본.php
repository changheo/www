...
<head>
	...
	if (isset($total_record) % isset($scale) == 0)     
		$total_page = floor(isset($total_record)/isset($scale));      
	else
		$total_page = floor(isset($total_record)/isset($scale)) + 1; 
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="sub_menu">
            <h3>홍보센터</h3>
            <ul>
                <li class="current"><a href="sub4_1.html">공지사항</a></li>
		...
		<form  name="board_form" method="post" action="list.php?mode=search"> 
			...
			<div id="list_total">▷ 총 <?= $total_record ?> 개의 게시물이 있습니다.  </div>
		</form>
